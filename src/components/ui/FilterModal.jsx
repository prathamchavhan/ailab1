        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
            ...
            <div className="relative top-0 right-0 h-full w-full md:w-96 bg-white shadow-xl ml-auto">
                ...
                <div className="flex justify-between items-center p-5 border-b sticky top-0 bg-white z-10">
                    <h2 className="text-xl font-bold text-[#09407F]">Filters</h2>
                ...
                {/* Filter Sections */}
                <div className="p-5 space-y-6 overflow-y-auto h-[calc(100%-120px)]">
                ...
                <div className="absolute bottom-0 w-full flex justify-end p-4 border-t bg-white">
                    <button 
                        onClick={handleClear} 
                        className="px-4 py-2 text-sm font-semibold text-gray-600 bg-gray-100 rounded-lg mr-3 hover:bg-gray-200"
                    >
                        Clear All
                    </button>
                    <button 
