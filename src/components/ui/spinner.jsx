...
import { Button } from "@/components/ui/button"; // <-- This is correct
import { Loader2 } from "lucide-react"; // <-- IMPORT THIS instead of Spinner
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className=" p-6 rounded-lg ">
              ...
              {/* Start Button --- UPDATED WITH Loader2 --- */}
              <div className="flex justify-center">
                <Button 
                  onClick={onStartTest} 
                  disabled={isLoading} 
                  className="w-full sm:w-auto text-white font-bold py-2 px-8 transition duration-300 disabled:bg-gray-400 h-auto text-sm"
                  style={{
                ...
                >
                  {isLoading ? (
                    <>
                      {/* Use Loader2 and give it the animate-spin utility class */}
