...
export async function POST(request) {
  console.log("API route '/api/generate-question' was hit.");
    ...
    for (const key of apiKeys) {
      try {
        ...
        const promptTemplate = `
          ...
          The questions should be of "${level}" make hard ,harder ,hardest difficulty . Ensure each array contains exactly 10 unique questions. Do not include any text, code fences, or explanations outside the JSON object itself.
        `;
